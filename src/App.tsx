...
import { ManageProductCategory } from "./pages/product-categories/manage";
    ...
    <Context>
      <HashRouter>
        <Routes>
          ...
          <Route path="/users" element={<Protected isSignedIn={!!token}><Admins /></Protected>} />
          ...
          <Route path="/product-categories" element={<Protected isSignedIn={!!token}><ProductCategories /></Protected>} />
          <Route path="/product-categories/:categoryId" element={<Protected isSignedIn={!!token}><ManageProductCategory /></Protected>} />
